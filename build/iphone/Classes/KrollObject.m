...
//@interface KulturlotseObject : NSObject
//@end

@interface KulturlotseObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[KulturlotseObject class]])
		{
			for (NSString *key in [[(KulturlotseObject*)o modules] allKeys])
			{
