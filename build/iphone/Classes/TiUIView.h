...
/**
 Base class for all Kulturlotse views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Kulturlotse view hierarchy (such as wrapped iOS UIViews) was touched.
