...
@interface KulturlotseObject : KrollCoverageObject {
#else
@interface KulturlotseObject : KrollObject {
#endif
@private
...
extern NSString * Kulturlotse$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	KulturlotseObject *_kulturlotse;
    KrollObject* console;
	BOOL shutdown;
