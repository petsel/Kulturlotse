...
// in simulator we redefine to format for Kulturlotse Developer console
...
{\
	NSString * exceptionName = [@"org.kulturlotse." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.kulturlotse";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIKulturlotseNativeItemNone = -1, 
	UIKulturlotseNativeItemSpinner = -2,
	UIKulturlotseNativeItemProgressBar = -3,
	
	UIKulturlotseNativeItemSlider = -4,
	UIKulturlotseNativeItemSwitch = -5,
	UIKulturlotseNativeItemMultiButton = -6,
	UIKulturlotseNativeItemSegmented = -7,
	
	UIKulturlotseNativeItemTextView = -8,
	UIKulturlotseNativeItemTextField = -9,
	UIKulturlotseNativeItemSearchBar = -10,
	
	UIKulturlotseNativeItemPicker = -11,
	UIKulturlotseNativeItemDatePicker = -12,
	
	UIKulturlotseNativeItemInfoLight = -13,
	UIKulturlotseNativeItemInfoDark = -14,
	
	UIKulturlotseNativeItemDisclosure = -15,
	
	UIKulturlotseNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Kulturlotse instances of
